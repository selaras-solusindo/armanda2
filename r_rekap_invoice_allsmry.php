...
//		$item->Visible = TRUE;
		...
		switch ($lvl) {
			...
			case 2:
				return (is_null($this->tanggal_short->CurrentValue) && !is_null($this->tanggal_short->OldValue)) ||
					...
					($this->tanggal_short->GroupValue() <> $this->tanggal_short->GroupOldValue()) || $this->ChkLvlBreak(1); // Recurse upper level
		}
	}
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL && !($this->RowTotalType == EWR_ROWTOTAL_GROUP && $this->RowTotalSubType == EWR_ROWTOTAL_HEADER)) { // Summary row
			...
			if ($this->RowTotalType == EWR_ROWTOTAL_GROUP && $this->RowGroupLevel >= 2) $this->RowAttrs["data-group-2"] = $this->tanggal_short->GroupOldValue(); // Set up group attribute 2
			...
			$this->tanggal_short->CellAttrs["class"] = ($this->RowGroupLevel == 2) ? "ewRptGrpSummary2" : "ewRptGrpField2";
			...
			if ($this->RowGroupLevel >= 2) $this->RowAttrs["data-group-2"] = $this->tanggal_short->GroupValue(); // Set up group attribute 2
			} else {
			$this->RowAttrs["data-group"] = $this->periode_short->GroupValue(); // Set up group attribute
			$this->RowAttrs["data-group-2"] = $this->tanggal_short->GroupValue(); // Set up group attribute 2
			}
			...
			$this->tanggal_short->CellAttrs["class"] = "ewRptGrpField2";
			$this->tanggal_short->CellAttrs["style"] = "width: 100px;";
			$this->tanggal_short->GroupViewValue = ewr_DisplayGroupValue($this->tanggal_short, $this->tanggal_short->GroupViewValue);
			if ($this->tanggal_short->GroupValue() == $this->tanggal_short->GroupOldValue() && !$this->ChkLvlBreak(2))
...
<?php } ?>
<?php if ($Page->tanggal_short->Visible && $Page->ChkLvlBreak(2) && $Page->tanggal_short->ShowGroupHeaderAsRow) { ?>
<?php
		...
		$Page->tanggal_short->Count = $Page->GetSummaryCount(2);
		$Page->RenderRow();
?>
	<tr<?php echo $Page->RowAttributes(); ?>>
<?php if ($Page->periode_short->Visible) { ?>
...
<?php } ?>
		<td data-field="tanggal_short" colspan="<?php echo ($Page->GrpColumnCount + $Page->DtlColumnCount - 2) ?>"<?php echo $Page->tanggal_short->CellAttributes() ?>>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
...
<?php } ?>
		<?php echo $ReportLanguage->Phrase("SummaryColon") ?>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_r_rekap_invoice_all_tanggal_short"<?php echo $Page->tanggal_short->ViewAttributes() ?>><?php echo $Page->tanggal_short->GroupViewValue ?></span>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_r_rekap_invoice_all_tanggal_short"<?php echo $Page->tanggal_short->ViewAttributes() ?>><?php echo $Page->tanggal_short->GroupViewValue ?></span></td>
	<?php } ?>
<?php } ?>
<?php if ($Page->nama->Visible) { ?>
		<td data-field="nama"<?php echo $Page->nama->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->RecCount ?>_r_rekap_invoice_all_nama"<?php echo $Page->nama->ViewAttributes() ?>><?php echo $Page->nama->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->no_kwitansi->Visible) { ?>
		<td data-field="no_kwitansi"<?php echo $Page->no_kwitansi->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->RecCount ?>_r_rekap_invoice_all_no_kwitansi"<?php echo $Page->no_kwitansi->ViewAttributes() ?>><?php echo $Page->no_kwitansi->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->nomor->Visible) { ?>
		<td data-field="nomor"<?php echo $Page->nomor->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->RecCount ?>_r_rekap_invoice_all_nomor"<?php echo $Page->nomor->ViewAttributes() ?>><?php echo $Page->nomor->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->no_sertifikat->Visible) { ?>
		<td data-field="no_sertifikat"<?php echo $Page->no_sertifikat->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->RecCount ?>_r_rekap_invoice_all_no_sertifikat"<?php echo $Page->no_sertifikat->ViewAttributes() ?>><?php echo $Page->no_sertifikat->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->tgl_pelaksanaan->Visible) { ?>
		<td data-field="tgl_pelaksanaan"<?php echo $Page->tgl_pelaksanaan->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->RecCount ?>_r_rekap_invoice_all_tgl_pelaksanaan"<?php echo $Page->tgl_pelaksanaan->ViewAttributes() ?>><?php echo $Page->tgl_pelaksanaan->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->total_ppn->Visible) { ?>
		<td data-field="total_ppn"<?php echo $Page->total_ppn->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->RecCount ?>_r_rekap_invoice_all_total_ppn"<?php echo $Page->total_ppn->ViewAttributes() ?>><?php echo $Page->total_ppn->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->tgl_bayar->Visible) { ?>
		<td data-field="tgl_bayar"<?php echo $Page->tgl_bayar->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->RecCount ?>_r_rekap_invoice_all_tgl_bayar"<?php echo $Page->tgl_bayar->ViewAttributes() ?>><?php echo $Page->tgl_bayar->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php
		...
		if ($Page->ChkLvlBreak(2) && $Page->tanggal_short->Visible) {
?>
<?php
			$Page->periode_short->Count = $Page->GetSummaryCount(1, FALSE);
			$Page->tanggal_short->Count = $Page->GetSummaryCount(2, FALSE);
...
<?php if ($Page->SubGrpColumnCount + $Page->DtlColumnCount > 0) { ?>
		<td colspan="<?php echo ($Page->SubGrpColumnCount + $Page->DtlColumnCount) ?>"<?php echo $Page->tgl_bayar->CellAttributes() ?>><?php echo str_replace(array("%v", "%c"), array($Page->tanggal_short->GroupViewValue, $Page->tanggal_short->FldCaption()), $ReportLanguage->Phrase("RptSumHead")) ?> <span class="ewDirLtr">(<?php echo ewr_FormatNumber($Page->Cnt[2][0],0,-2,-2,-2) ?><?php echo $ReportLanguage->Phrase("RptDtlRec") ?>)</span></td>
<?php } ?>
	</tr>
	<tr<?php echo $Page->RowAttributes(); ?>>
<?php if ($Page->periode_short->Visible) { ?>
...
<?php if ($Page->GrpColumnCount > 0) { ?>
		<td colspan="<?php echo ($Page->GrpColumnCount - 1) ?>"<?php echo $Page->tanggal_short->CellAttributes() ?>><?php echo $ReportLanguage->Phrase("RptSum") ?></td>
<?php } ?>
<?php if ($Page->nama->Visible) { ?>
		<td data-field="nama"<?php echo $Page->tanggal_short->CellAttributes() ?>>&nbsp;</td>
<?php } ?>
