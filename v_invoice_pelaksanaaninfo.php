...
$v_invoice_pelaksanaan = NULL;

//
// Table class for v_invoice_pelaksanaan
//
class cv_invoice_pelaksanaan extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'v_invoice_pelaksanaan';
		$this->TableName = 'v_invoice_pelaksanaan';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_invoice_pelaksanaan`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// invoice_id
		$this->invoice_id = new cField('v_invoice_pelaksanaan', 'v_invoice_pelaksanaan', 'x_invoice_id', 'invoice_id', '`invoice_id`', '`invoice_id`', 3, -1, FALSE, '`invoice_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`v_invoice_pelaksanaan`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "v_invoice_pelaksanaanlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("v_invoice_pelaksanaanview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("v_invoice_pelaksanaanview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "v_invoice_pelaksanaanadd.php?" . $this->UrlParm($parm);
		else
			$url = "v_invoice_pelaksanaanadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("v_invoice_pelaksanaanedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("v_invoice_pelaksanaanadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("v_invoice_pelaksanaandelete.php", $this->UrlParm());
	}
