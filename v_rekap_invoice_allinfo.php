...
$v_rekap_invoice_all = NULL;

//
// Table class for v_rekap_invoice_all
//
class cv_rekap_invoice_all extends cTable {
	var $nama;
	var $invoice_id;
	var $nomor;
	var $tanggal;
	...
	function __construct() {
		...
		$this->TableVar = 'v_rekap_invoice_all';
		$this->TableName = 'v_rekap_invoice_all';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_rekap_invoice_all`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// nama
		$this->nama = new cField('v_rekap_invoice_all', 'v_rekap_invoice_all', 'x_nama', 'nama', '`nama`', '`nama`', 200, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama->Sortable = TRUE; // Allow sort
		$this->fields['nama'] = &$this->nama;

		// invoice_id
		$this->invoice_id = new cField('v_rekap_invoice_all', 'v_rekap_invoice_all', 'x_invoice_id', 'invoice_id', '`invoice_id`', '`invoice_id`', 3, -1, FALSE, '`invoice_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nomor
		$this->nomor = new cField('v_rekap_invoice_all', 'v_rekap_invoice_all', 'x_nomor', 'nomor', '`nomor`', '`nomor`', 200, -1, FALSE, '`nomor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nomor->Sortable = TRUE; // Allow sort
		$this->fields['nomor'] = &$this->nomor;

		// tanggal
		$this->tanggal = new cField('v_rekap_invoice_all', 'v_rekap_invoice_all', 'x_tanggal', 'tanggal', '`tanggal`', ew_CastDateFieldForLike('`tanggal`', 0, "DB"), 133, 0, FALSE, '`tanggal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tanggal->Sortable = TRUE; // Allow sort
		$this->tanggal->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['tanggal'] = &$this->tanggal;

		// no_sertifikat
		$this->no_sertifikat = new cField('v_rekap_invoice_all', 'v_rekap_invoice_all', 'x_no_sertifikat', 'no_sertifikat', '`no_sertifikat`', '`no_sertifikat`', 201, -1, FALSE, '`no_sertifikat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->no_sertifikat->Sortable = TRUE; // Allow sort
		$this->fields['no_sertifikat'] = &$this->no_sertifikat;

		// total_ppn
		$this->total_ppn = new cField('v_rekap_invoice_all', 'v_rekap_invoice_all', 'x_total_ppn', 'total_ppn', '`total_ppn`', '`total_ppn`', 4, -1, FALSE, '`total_ppn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// no_kwitansi
		$this->no_kwitansi = new cField('v_rekap_invoice_all', 'v_rekap_invoice_all', 'x_no_kwitansi', 'no_kwitansi', '`no_kwitansi`', '`no_kwitansi`', 200, -1, FALSE, '`no_kwitansi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_kwitansi->Sortable = TRUE; // Allow sort
		$this->fields['no_kwitansi'] = &$this->no_kwitansi;

		// tgl_pelaksanaan
		$this->tgl_pelaksanaan = new cField('v_rekap_invoice_all', 'v_rekap_invoice_all', 'x_tgl_pelaksanaan', 'tgl_pelaksanaan', '`tgl_pelaksanaan`', '`tgl_pelaksanaan`', 201, -1, FALSE, '`tgl_pelaksanaan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->tgl_pelaksanaan->Sortable = TRUE; // Allow sort
		$this->fields['tgl_pelaksanaan'] = &$this->tgl_pelaksanaan;

		// periode
		$this->periode = new cField('v_rekap_invoice_all', 'v_rekap_invoice_all', 'x_periode', 'periode', '`periode`', ew_CastDateFieldForLike('`periode`', 0, "DB"), 133, 0, FALSE, '`periode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "v_rekap_invoice_alllist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("v_rekap_invoice_allview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("v_rekap_invoice_allview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "v_rekap_invoice_alladd.php?" . $this->UrlParm($parm);
		else
			$url = "v_rekap_invoice_alladd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("v_rekap_invoice_alledit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("v_rekap_invoice_alladd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("v_rekap_invoice_alldelete.php", $this->UrlParm());
	}
